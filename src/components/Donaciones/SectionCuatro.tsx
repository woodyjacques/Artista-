...
function SectionCuatro() {
    return (
        <div className="font-quicksand max-w-7xl mx-auto p-8 flex flex-col lg:flex-row items-center lg:items-start gap-12 -mb-20">

            <div className="lg:w-1/2 space-y-4">
                <p className="text-red-800 font-semibold text-lg">Tu Donación Hace la Diferencia</p>

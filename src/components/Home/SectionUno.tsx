...
function SectionUno() {
    return (
        <section className="font-arima text-white p-20 rounded-3xl max-w-6xl mx-auto my-20 shadow-2xl relative bg-cover bg-center" style={{ backgroundImage: `url(${young})` }}>

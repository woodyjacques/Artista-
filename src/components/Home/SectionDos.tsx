...
function SectionDos() {
    return (
        <section className="font-arima text-white p-20 rounded-3xl max-w-7xl mx-auto my-20  relative bg-cover bg-center">
            <div className="absolute inset-0  rounded-3xl"></div>
            <div className="relative z-10 text-center">
                <h3 className="text-red-800 text-xl font-semibold mb-4">¡Conoce cómo estamos haciendo la diferencia!</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                <div className="bg-white shadow-md p-6 rounded-lg  flex flex-col md:flex-row items-center">
                    ...
                    <div className="flex flex-col flex-grow">
                        <h4 className="text-xl font-bold mb-2">"Rutas del Arte"</h4>
                        ...
                        <p className="text-sm text-gray-600 mb-2">Beneficiados: 9</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center">
                    ...
                    <div className="flex flex-col flex-grow">
                        <h4 className="text-xl font-bold mb-2">"Techo Creativo"</h4>
                        <p className="text-gray-700 mb-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center">
                    ...
                    <div className="flex flex-col flex-grow">
                        <h4 className="text-xl font-bold mb-2">"Espacios para Soñar"</h4>
                        <p className="text-gray-700 mb-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center">
                    ...
                    <div className="flex flex-col flex-grow">
                        <h4 className="text-xl font-bold mb-2">"Voces que sanan"</h4>
                        <p className="text-gray-700 mb-4">

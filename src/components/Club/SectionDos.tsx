    ...
    return (
        <div className="font-arima flex flex-col lg:flex-row bg-gray-100 p-8 rounded-lg shadow-md max-w-7xl mx-auto">
            ...
            <div className="flex-1 space-y-8">
                ...
                <BenefitItem icon={tarjetas} title="Tarjetas BONO" description="Regalos Especiales: En los meses de septiembre y diciembre, recibe dos tarjetas de $50 dólares para disfrutar de lo que más necesites." />
            </div>
            ...
            <div className="relative bg-blue-900 text-white p-8 rounded-lg flex flex-col items-start justify-center space-y-6 mt-8 lg:mt-0 lg:ml-8 lg:w-1/3 max-w-sm lg:max-w-md" style={{ backgroundImage: `url(${young})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <img src={manoTarjetaDerecha} alt="Tarjeta de Membresía" className="w-48 h-auto mt-4 self-center z-10" />
            </div>

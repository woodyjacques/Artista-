...
function SectionTres() {
    return (
        <div className="font-arima bg-white rounded-lg shadow-md p-6 md:p-8 flex flex-col md:flex-row-reverse items-center md:items-start space-y-4 md:space-y-0 md:space-x-8 max-w-full w-full mx-auto">
            ...
            <div className="flex-1 space-y-3 md:space-y-4 text-center md:text-left">
                <h4 className="text-2xl font-semibold">Nombre del evento</h4>

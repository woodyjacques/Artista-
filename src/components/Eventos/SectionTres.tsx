...
function SectionTres() {
    return (
        <div className="font-aristotelicaLight bg-white rounded-lg shadow-md p-6 md:p-8 flex flex-col md:flex-row-reverse items-center md:items-start space-y-4 md:space-y-0 md:space-x-8 max-w-full w-full mx-auto">

...
function SectionCinco() {
    return (
        <div className="font-arima grid gap-6 sm:grid-cols-2 lg:grid-cols-3 p-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 max-w-sm mx-auto">
                ...
                <div className="mt-5">
                    <a href="#" className="text-yellow-600 font-semibold text-base flex items-center">
                        Saber más
            ...
            <div className="bg-white rounded-lg shadow-md p-6 max-w-sm mx-auto">
                ...
                <div className="mt-5">
                    <a href="#" className="text-blue-600 font-semibold text-base flex items-center">
                        Saber más
                        <span className="ml-1">→</span>
                    </a>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 max-w-sm mx-auto">
                ...
                <div className="mt-5">
                    <a href="#" className="text-pink-600 font-semibold text-base flex items-center">
                        Saber más
                        <span className="ml-1">→</span>
                    </a>
                </div>
